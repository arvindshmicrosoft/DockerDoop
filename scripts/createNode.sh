...
if [[ -n $5 ]]; then
    ...
    ports=(22 2181 3000 3372 3373 4040 6080 6627 6667 6700 6701 6702 6703 8000 8010 8020 8025 8030 8032 8050 8080 8081 8088 8141 8744 8886 8983 9000 9080 9081 9082 9083 9084 9085 9086 9087 9090 9999 9933 9995 10000 10020 11000 16010 18080 19888 21000 45454 50010 50020 50060 50070 50075 50090 50111 61080)
    for i in ${ports[@]}; do
